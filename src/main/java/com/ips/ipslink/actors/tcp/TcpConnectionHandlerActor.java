...
import com.ips.ipslink.marshallers.RequestJson;
import com.ips.ipslink.resources.SharedResources;
								...
								if(SharedResources.isValidatedIPSreq(log, getSelf(), resourceMap)){
									...
									if(SharedResources.isValidIP(resourceMap.get("pedIp")) && SharedResources.isValidPort(resourceMap.get("pedPort"))){		
										...
										if(resourceMap.get("printFlag") != null && resourceMap.get("wait4CardRemoved") != null && resourceMap.get("printFlag").equals("0") && resourceMap.get("wait4CardRemoved").equalsIgnoreCase("true")){
	                                        ...
	                                        if(resourceMap.get("operationType").equals("ProbePed") /*||resourceMap.get("operationType").equals("UpdateDll")||resourceMap.get("operationType").equals("FirstDll")*/){
	                                            printOnECR = false;
